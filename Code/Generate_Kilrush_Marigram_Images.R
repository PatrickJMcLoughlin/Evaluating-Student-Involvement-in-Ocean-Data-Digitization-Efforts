...
# ================================
# **USER INSTRUCTION**: 
# Change the working directory path below to a folder on your local machine where you want to save the marigrams.
# Example: 
# setwd("C:/path/to/your/folder")
# On macOS or Linux, the path might look like:
# setwd("/Users/yourname/Documents/Colour_Marigrams")
setwd("C:/Users/patri/Downloads/Colour_Marigrams")  # <-- MODIFY THIS PATH TO YOUR OWN DIRECTORY
