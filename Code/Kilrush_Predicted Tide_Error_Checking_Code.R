...
# ============================================
# Change the working directory to the folder where your data and files are stored.
# Set the directory for your data and output files below (adjust paths accordingly).
# Instructions: Replace the paths with your own working directory.
# E.g., setwd("C:/path/to/your/folder") for Windows or setwd("/path/to/your/folder") for Mac/Linux.

setwd("C:/path/to/your/working/directory")  # Adjust this path to your local working directory
...
# Save the calculated tide model for future use (adjust path as needed)
save(ftide_calc_kilrush, file = "ftide_calc_kilrush.Rdata")  # Save in your working directory
...
# Save the marigram plot (adjust path if necessary)
...
# Set the correct file path for your data (adjust as needed)
file <- "High_and_Low_Tides_Week14-17_Kilrush.xlsx"  # Adjust filename and path as needed
...
# ============================================
# Function to Summarize Weekly Residuals
# ============================================
# Function to summarize data for each week
get_weekly_residual_summary <- function(week_num, output = FALSE) {
  week_data <- data %>% filter(Week == week_num) # Filter data for the specified week
  ...
  top_residuals <- week_data %>% arrange(desc(abs(Residual))) %>%
...
# Prepare to write summaries to a text file (adjust file path as needed)
output_file <- "kilrush_weekly_residuals_summary.txt"  # Adjust output file name and path
